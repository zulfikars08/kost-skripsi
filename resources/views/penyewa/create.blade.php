...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        lokasiSelect.addEventListener("change", function () {
            ...
            // Tampilkan hanya opsi nomor kamar yang sesuai dengan "Nama Kos" dan status yang dipilih
            Object.keys(kamarOptions).forEach((kamarId) => {
                const lokasiId = kamarOptions[kamarId].lokasi_id;
                const status = kamarOptions[kamarId].status;

                if (!selectedLokasiId || (lokasiId == selectedLokasiId && status == 'Belum Terisi')) {
